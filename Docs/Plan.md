...
Competion tags:
Completed items [✅] - Including authentication foundation, basic navigation, environment setup, and many design system requirements
In-progress items [🔘🔄] - Such as onboarding screens and user profile setup
Pending items [🔘] - Including most future features and monitoring setup
